...
class ServerSelected {
    ...
    /*
     * AXEr : Vous n'�tes pas autoris� � rejoindre le serveur.
     * AXEd : Le serveur selectionn� n'est pas disponible.
     * AXEf : Serveur : COMPLET.
     * AXEs : Impossible de s�lectionner ce perso car il est vendeur sur le serveur
     * undefined.
     */
