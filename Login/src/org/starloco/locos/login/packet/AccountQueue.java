...
class AccountQueue {
    ...
    /*
     * AlEa - None : Deja en connexion. Veuillez reessayer
     * AlEb : Connexion refusee. Ton compte a ete banni.
     * AlEc - None : Ce compte est deja connecte à un serveur de jeu. Veuillez reessayer.
     * AlEd : Tu viens de deconnecter un personnage utilisant deja ce compte.
     * AlEe - None : ATTENTION : Vous devez utilisez vos identifiants ANkama Games ! ...
