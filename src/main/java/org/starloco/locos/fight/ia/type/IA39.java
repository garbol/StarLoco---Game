...
public class IA39 extends AbstractNeedSpell  {
    ...
    public void apply() {
        if (!this.stop && this.fighter.canPlay() && this.count > 0) {
            ...
            Fighter L2 = Function.INSTANCE.getgetNearestEnnemynbrcasemax(this.fight, this.fighter, 2, 5);
            Fighter L3 = Function.INSTANCE.getgetNearEnnemylignenbrcasemax(this.fight, this.fighter, 0, maxPo);
            ...
            if(this.fighter.getCurPm(this.fight) > 0 && C == null || this.attack == 1 && this.fighter.getCurPm(this.fight) > 0) {
                int value = Function.INSTANCE.getmoveenfaceIfPossible(this.fight, this.fighter, ennemy, maxPo + 1);
                if(value != 0) {
                    time = value;
                    action = true;
            ...
            if(this.fighter.getCurPa(this.fight) > 0 && C != null && !action) {
                ...
                if(value != 0) {
                    ...
                    value = Function.INSTANCE.getmoveenfaceIfPossible(this.fight, this.fighter, L2, maxPo + 1);
                    if(value != 0) {
                        time = value;
                        action = true;
                    }
