...
public class French extends AbstractLang {
    ...
    public void initialize() {
        ...
        this.sentences.add(index, "<b>" + Config.getInstance().NAME + " - <a href='" + Config.getInstance().url + "'>Site</a></b>\nEn ligne depuis : #1j #2h #3m #4s."); index++;
        ...
        this.sentences.add(index, "Les commandes disponnibles sont :\n"
                ...
                (Config.getInstance().TEAM_MATCH ? "<b>.kolizeum</b> - Vous inscrit/désincrit de la liste d'attente de Kolizeum.\n" : "") +
                (Config.getInstance().DEATH_MATCH ? "<b>.deathmatch</b> - Vous inscrit/désincrit de la liste d'attente de DeathMatch.\n" : "") +
        ...
        this.sentences.add(index, "Vous pouvez dès à présent voter, <b><a href='" + Config.getInstance().url + "'>clique ici</a></b> !"); index++;
